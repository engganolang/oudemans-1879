...
- the derived dataset using the DOI of the [particular released version](../../releases/) you were using
  > Rajeg, Gede Primahadi Wijaya (2025). CLDF dataset derived from Oudemans' "Woordenlijst van de Talen van Enggano, Mentawei en Nias" from 1879. University of Oxford. Dataset. (v1.0.0) https://doi.org/10.25446/oxford.28436033.v1
